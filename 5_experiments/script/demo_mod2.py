...
class VisionTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=100,
        ...
        self._init_weights()
        self.visualization_mode = False  # Thêm flag này
    ...
    def forward(self, x):
        ...
        for layer in self.layers:
            if self.visualization_mode:
                ...
                x, _ = layer(x)  # Bỏ qua attention weights
...
class CustomTransformerEncoderLayer(nn.Module):
    def __init__(self, d_model, nhead, dim_feedforward=3072, dropout=0.1):
        ...
        # Thêm biến để lưu attention weights
    ...
    def forward(self, src):
        ...
        # Reshape Q, K, V cho multi-head attention
        ...
        # Lưu attention weights để visualization
        ...
        # Trả về cả output và attention weights
